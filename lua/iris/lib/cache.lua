---@mod iris.lib.cache "Cache — LRU Render Output Cache"
---@brief [[
...
---@param path string
---@param mtime number
---@param max_geometry IrisGeometry
---@return table|nil
...
---@param fit_geometry IrisGeometry Actual fitted dimensions
